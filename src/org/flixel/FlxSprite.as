	...
	*/
	public class FlxSprite extends FlxCore
	{
		...
		*/
		...
		//Physics
		protected var _targetVelocity:b2Vec2;
		...
		public function FlxSprite(X:int=0,Y:int=0,SimpleGraphic:Class=null)
		{
			...
			_targetVelocity = new b2Vec2(0, 0);
		...
		public function set velocity(v:b2Vec2) :void
		{
			_targetVelocity = new b2Vec2(v.x, v.y);
		}
		...
		*/
		override public function update():void
		{
			...
			{
				//if(_targetVelocity)
				//	body.SetLinearVelocity(_targetVelocity);
